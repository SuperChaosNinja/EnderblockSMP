package net.undercoverenderman.enderblocksmp.block;
...
public class ModBlocks {
    public static final DeferredRegister.Blocks BLOCKS =
            DeferredRegister.createBlocks(EnderblockSMP.MOD_ID);

    public static final DeferredBlock<Block> ANDESITE_MACHINE = registerBlock("andesite_machine",
            () -> new Block(BlockBehaviour.Properties.of()
                    .strength(4f).requiresCorrectToolForDrops().sound(SoundType.WOOD).explosionResistance(3.0f)));
